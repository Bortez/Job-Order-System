...
<div class="portlet-title">
	<div class="caption font-green-sharp">
		...
		<span class="caption-subject bold uppercase"> New Customer</span>
	</div>
	<div class="actions">
			...
			<div class="row">
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input name="name" type="text" placeholder="This field is required" id="form_control_1" class="form-control">
						<label for="form_control_1">Customer Name</label>
						<span class="help-block">Add item customer name here.</span>
					</div>
				</div>
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input name="email" type="text" placeholder="Customer email is optional" id="form_control_2" class="form-control">
						<label for="form_control_2">Email</label>
						<span class="help-block">Add customer email here.</span>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<textarea name="address" id="form_control_3" placeholder="Customer address is optional" rows="3" class="form-control"></textarea>
						<label for="form_control_3">Address</label>
						<span class="help-block">Add customer address here.</span>
					</div>
				</div>
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input name="telephone" type="text" placeholder="Customer telephone is optional" id="form_control_4" class="form-control">
						<label for="form_control_4">Telephone #</label>
						<span class="help-block">Add customer telephone # here.</span>
					</div>
				</div>
			</div>
...
<div class="portlet-body form">
	...
	<form role="form" id="form_update" method="post" action="" novalidate="novalidate" enctype="multipart/form-data" update_link="<?php echo base_url('customers/update/'.$row_id); ?>">
		<div class="form-body">
			<div class="row">
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input value="<?php echo isset($data['name']) ? $data['name'] : ''; ?>" name="name" type="text" placeholder="This field is required" id="form_control_1" class="form-control">
						<label for="form_control_1">Customer Name</label>
						<span class="help-block">Add item customer name here.</span>
					</div>
				</div>
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input value="<?php echo isset($data['email']) ? $data['email'] : ''; ?>" name="email" type="text" placeholder="Customer email is optional" id="form_control_2" class="form-control">
						<label for="form_control_2">Email</label>
						<span class="help-block">Add customer email here.</span>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<textarea name="address" id="form_control_3" placeholder="Customer address is optional" rows="3" class="form-control"><?php echo isset($data['address']) ? $data['address'] : ''; ?></textarea>
						<label for="form_control_3">Address</label>
						<span class="help-block">Add customer address here.</span>
					</div>
				</div>
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input value="<?php echo isset($data['telephone']) ? $data['telephone'] : ''; ?>" name="telephone" type="text" placeholder="Customer telephone is optional" id="form_control_4" class="form-control">
						<label for="form_control_4">Telephone #</label>
						<span class="help-block">Add customer telephone # here.</span>
					</div>
				</div>
