...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			...
			<a href="<?php echo base_url('accres'); ?>">Account Receivable</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
...
<div class="portlet-title">
	<div class="caption font-green-sharp">
		...
		<span class="caption-subject bold uppercase"> New Account Receivable</span>
	</div>
	<div class="actions">
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input name="amount" type="text" placeholder="Account payable is required" id="form_control_2" class="form-control">
						<label for="form_control_2">Account Payable</label>
						<span class="help-block">Add account payable here.</span>
					</div>
				</div>
			</div>
			<div class="row">
...
<div class="portlet-title">
	<div class="caption font-green-sharp">
		...
		<span class="caption-subject bold uppercase"> Edit Account Reveivable</span>
	</div>
	<div class="actions">
		<a title="" data-original-title="" href="javascript:;" class="btn btn-circle btn-icon-only btn-default fullscreen">
		</a>
...
<div class="portlet-body form">
	...
	<form role="form" id="form_update" method="post" action="" novalidate="novalidate" enctype="multipart/form-data" update_link="<?php echo base_url('accres/update/'.$row_id); ?>">
		<div class="form-body">
			<div class="row">
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input unline-input">
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12">
					<div class="form-group form-md-line-input">
						<input type="textbox" name="amount" id="amount" placeholder="Account Payable is required" class="form-control" value="<?php echo isset($data['amount']) ? $data['amount'] : ''; ?>" />
						<label for="form_control_4">Account Payable</label>
						<span class="help-block">Add account payable here.</span>
					</div>
				</div>
			</div>
...
<div class="portlet-title">
	<div class="caption font-green-sharp">
		...
		<span class="caption-subject bold uppercase"> View Account Receivable</span>
	</div>
	<div class="actions">
		<a title="" data-original-title="" href="javascript:;" class="btn btn-circle btn-icon-only btn-default fullscreen">
		</a>
	...
	<div class="panel panel-default">
		...
		<div id="order_info" class="panel-collapse in">
			<div class="panel-body">
				...
				$sql = "Select * From account_payment Where acc_id = ".$id." Order by payment_date desc";
				...
				if($query->num_rows() > 0){
					...
					echo "<tr>";
						...
						echo "<td class=\"highlight\"><a>Total Amount Paid: </a></td>";
						echo '<td></td>';
