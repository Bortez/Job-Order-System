...
<script type="text/javascript" src="<?php echo base_url('assets/custom/js/modules/forms/layaway.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/plugins/datatables/media/js/jquery.dataTables.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/custom/js/modules/grids/layaway-editable.js'); ?>"></script>
<script>
